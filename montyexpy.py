...
def main():
    ...
    for z in range(1, z + 1):
        ...
        # if randomly switching door results in win
        # count up the wins and find the decimal result
        if monterandom(win3) == True:
            win3 += 1
            # result of wins
            result3 = win3 / z
    ...
    print(win1, "games)")
    print("Randomly switching wins:", "%9.7f" % (result3), "(", end="")
    print(win3, "games)"
...
# points and coordinates scaled by 2
    ...
    # draw Randomly bar
    histogram.goto(225, -120)
    histogram.pendown()
    histogram.begin_fill()
    histogram.backward((result3 * 200))
    histogram.right(90)
    histogram.forward(80)
    histogram.left(90)
    histogram.forward((result3 * 200))
    histogram.end_fill()

    #result
    histogram.penup()
    histogram.goto(165, (result3 * 200) -120)
    histogram.write(result3)

    #label as randomly
    histogram.goto(165, -136)
    histogram.write("Randomly")

    # write the title of graph, first sentence
    histogram.goto(0, -150)
    histogram.write("The Monty Hall Problem: 100000 games", ("Arial", 10, "normal"))

    # write second sentece
    histogram.goto(-20, -160)
